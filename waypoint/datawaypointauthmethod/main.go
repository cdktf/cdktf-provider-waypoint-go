...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataWaypointAuthMethod)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-waypoint.dataWaypointAuthMethod.DataWaypointAuthMethodConfig",
		reflect.TypeOf((*DataWaypointAuthMethodConfig)(nil)).Elem(),
	)
}
