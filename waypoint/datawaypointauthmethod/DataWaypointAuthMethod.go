...
import (
	...
	"github.com/cdktf/cdktf-provider-waypoint-go/waypoint/v3/datawaypointauthmethod/internal"
...
func (d *jsiiProxy_DataWaypointAuthMethod) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataWaypointAuthMethod) ToHclTerraform() interface{} {
	var returns interface{}
