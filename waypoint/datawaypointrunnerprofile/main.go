...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataWaypointRunnerProfile)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-waypoint.dataWaypointRunnerProfile.DataWaypointRunnerProfileConfig",
		reflect.TypeOf((*DataWaypointRunnerProfileConfig)(nil)).Elem(),
	)
}
