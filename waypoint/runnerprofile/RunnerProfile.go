...
import (
	...
	"github.com/cdktf/cdktf-provider-waypoint-go/waypoint/v3/runnerprofile/internal"
...
func RunnerProfile_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateRunnerProfile_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (r *jsiiProxy_RunnerProfile) AddMoveTarget(moveTarget *string) {
...
func (r *jsiiProxy_RunnerProfile) HasResourceMove() interface{} {
	var returns interface{}
...
func (r *jsiiProxy_RunnerProfile) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (r *jsiiProxy_RunnerProfile) MoveFromId(id *string) {
...
func (r *jsiiProxy_RunnerProfile) MoveTo(moveTarget *string, index interface{}) {
...
func (r *jsiiProxy_RunnerProfile) MoveToId(id *string) {
...
func (r *jsiiProxy_RunnerProfile) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (r *jsiiProxy_RunnerProfile) ToHclTerraform() interface{} {
	var returns interface{}
