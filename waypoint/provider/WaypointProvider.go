...
import (
	...
	"github.com/cdktf/cdktf-provider-waypoint-go/waypoint/v3/provider/internal"
...
func WaypointProvider_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateWaypointProvider_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (w *jsiiProxy_WaypointProvider) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (w *jsiiProxy_WaypointProvider) ToHclTerraform() interface{} {
	var returns interface{}
